...
redirect_from: "/display/KD/%5BMobile%5D+Verify+Is+Landscape" 
description: 
---
Description  
-------------
...
<table><thead><tr><th>Param Type</th><th>Description</th></tr></thead><tbody><tr><td><span>Boolean</span></td><td><span>true, if the device is in landscape mode; otherwise, false.</span></td></tr></tbody></table>
