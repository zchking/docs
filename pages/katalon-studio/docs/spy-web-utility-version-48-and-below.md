...
1.  Click on **Spy Web** from the main toolbar.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-2-23-133A203A14.png)  
      
    
2.  The **Object Spy** dialog will be displayed.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-193A523A37.png)  
      
    
3.  Click on **Start** to begin capturing objects from the web browser.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-193A463A58.png)  
    Where:
    
    <table><thead><tr><th>Type</th><th>Description</th></tr></thead><tbody><tr><td>New Browsers</td><td>Launch a new browser and start spying web objects from that browser.</td></tr><tr><td>Active Browsers</td><td><p>Focus on <strong>the current active Chrome browser</strong> and start spying web objects from it. You will be asked for installation of Katalon Utility:</p><p><img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-2-23-113A543A29.png"></p><p>Refer to <a href="/display/KD/Katalon+Addon+for+Chrome">Katalon Addon for Chrome</a> for more details.</p></td></tr></tbody></table>
...
4.  Your selected browser will be launched. Navigate to your website, then hover the **mouse cursor** over the web object to be captured.  
    ...
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2016-12-29-163A553A52.png)  
...
5.  Press the combination of **<Alt + back quote>** keys on the keyboard to capture object. The object will be highlighted in the **green border**.   
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2016-12-29-173A43A7.png)  
      
    
6.  You can go back to the **Object Spy** dialog to view the captured objects.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2016-12-29-173A63A29.png)  
...
7.  Click on **Add to Object Repository** from command toolbar.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2016-12-29-173A153A0.png)  
...
8.  Check on those captured objects in the **left pane** that you would like to save into Katalon Studio.   
    ...
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2016-12-29-173A153A54.png)  
      
    
9.  The captured objects will be added to **Object Repository** accordingly.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2016-12-29-173A223A57.png)
...
1.  **Add a Page element**: Whenever activities are taken on a new web page, that page will be captured into the **Object Spy** dialog. Click on **New page** from toolbar to add a new Page element manually.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-1-3-113A503A2.png)
...
2.  **Add a Frame element**: Frames are web elements that usually contain many other web objects. Click on **New frame** from toolbar to manually add a new Frame element.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-1-3-133A563A48.png)
...
3.  **Add an Object element**: Click on the **New object** from the toolbar to manually add a web object.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-1-3-163A533A2.png)  
...
4.  Click **Delete** to remove any element.   
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-1-3-163A553A12.png)
...
1.  Press the combination of **<Ctrl + Alt + back quote>** keys on the keyboard to load **DOM map**.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-1-10-103A343A55.png)  
      
    
2.  The entire HTML code of the page is loaded in **preview section** of the **Object Spy** dialog. For example:  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-193A593A1.png)  
...
3.  Enter the **xpath** value in the **search field** just above the **preview section** then press **Enter**. Any found element that matches with the **xpath** value will be highlighted.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-203A43A14.png)
...
2.  Right click on the element to open its context menu then select **Verify**.  
    ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-1-10-113A193A30.png)  
...
3.  Katalon Studio will start browsing the **HTML DOM** content with the **xpath** value of the selected object.
    1.  If there is a web object with matched **xpath** value, it will be highlighted in the preview section. The selected object in **Capture Objects** section will also be marked as "**existed**".  
        ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-203A93A27.png)
    2.  If there is no object found, the selected object in **Capture Objects** section will be marked as "**missing**".  
        ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-203A123A1.png)
    3.  If there are more than one web object found, they will be highlighted in preview section. The selected object in **Capture Objects** section will also be marked as "**multiple found**".  
        ![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/spy-web-utility-version-48-and-below/image2017-6-30-203A163A50.png)