...
6.  The **Input** dialog is displayed.   
    ...
    <table class="wrapped confluenceTable" style="table-layout: fixed;"><thead><tr><th class="xtd-0-0 confluenceTh" style="">Field</th><th class="xtd-0-1 confluenceTh" style="">Description</th></tr></thead><tbody style=""><tr class="xtr-1" style=""><td class="xtd-1-0 confluenceTd" style="">No</td><td class="xtd-1-1 confluenceTd" style="">The number of parameter for the selected keyword.</td></tr><tr class="xtr-2" style=""><td class="xtd-2-0 confluenceTd" style="">Param Name</td><td class="xtd-2-1 confluenceTd" style="">The name of the parameter.</td></tr><tr class="xtr-3" style=""><td class="xtd-3-0 confluenceTd" style="">Param Type</td><td class="xtd-3-1 confluenceTd" style="">The required data type for the parameter.</td></tr><tr class="xtr-4" style=""><td class="xtd-4-0 confluenceTd" style="">Value Type</td><td class="xtd-4-1 confluenceTd" style="">The type of your input value (e.g. strings, <a href="https://docs.katalon.com/display/KD/Variable+Types" rel="nofollow" style="">variables</a>, <a href="https://docs.katalon.com/display/KD/Manage+Test+Data" rel="nofollow" style="">data sources</a>...)</td></tr><tr class="xtr-5" style=""><td class="xtd-5-0 confluenceTd" style="">Value</td><td class="xtd-5-1 confluenceTd" style=""><div class="content-wrapper" style=""><p style="">The input value for this parameter.</p><div class="confluence-information-macro confluence-information-macro-note conf-macro output-block" data-hasbody="true" data-macro-name="note" style=""><span class="aui-icon aui-icon-small aui-iconfont-warning confluence-information-macro-icon" style=""></span><div class="confluence-information-macro-body" style=""><p style=""><span style="">Input value can be varied based on&nbsp;</span><strong style="">Value Type</strong><span style="">. Refer to&nbsp;</span><a href="https://docs.katalon.com/display/KD/Value+Types" rel="nofollow" style="">Value Types in Katalon</a><span style="">&nbsp;for more details.</span></p></div></div></div></td></tr></tbody></table>
