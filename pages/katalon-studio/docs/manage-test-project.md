...
- **API/Web Service**: Exclusive features for API/Web Service Testing are enabled including Quickstart wizard, Import Swagger/WSDL defition from File or URL, Request History list and much more.
    
![](https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/copy-of-manage-test-project/New-Project.png)**
