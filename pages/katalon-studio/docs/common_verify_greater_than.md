...
permalink: katalon-studio/docs/common_verify_greater_than.html 
description: 
---
Description  
-------------
...
<table class="wrapped relative-table confluenceTable" style="width: 52.3247%;"><colgroup><col style="width: 15.083%;"><col style="width: 84.917%;"></colgroup><tbody><tr class="xtr-0"><th class="xtd-0-0 confluenceTh">Param Type</th><th class="xtd-0-1 confluenceTh">Description</th></tr><tr class="xtr-1"><td class="xtd-1-0 confluenceTd"><span style="color: rgb(0,0,0);">Boolean</span></td><td class="xtd-1-1 confluenceTd"><ul><li><p><span style="color: rgb(0,0,0);"><strong>true</strong>&nbsp;if the actual number is greater than the expected number.</span></p></li><li><p><span style="color: rgb(0,0,0);"><strong>false</strong>&nbsp;if the actual number is NOT greater than the expected number.</span></p></li></ul></td></tr></tbody></table>
...
*   Manual view    
    ![](../../images/katalon-studio/docs/common_verify_greater_than/image2017-3-3 17_29_1.png)
*   Script view 
