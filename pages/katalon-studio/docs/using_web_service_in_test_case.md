...
permalink: katalon-studio/docs/using_web_service_in_test_case.html 
description: 
---
### In Manual View
...
1.  Open a test case in **Manual** view, then select option to add **Web Service Keyword** from command toolbar.  
    ![](../../images/katalon-studio/docs/using_web_service_in_test_case/image2017-6-30 20_49_48.png)  
...
2.  A Web Service step is added to the test case.   
    ...
    ![](../../images/katalon-studio/docs/using_web_service_in_test_case/image2017-6-30 20_50_17.png)  
...
3.  Double click on object cell to specify the web service object to **[Send Request](https://docs.katalon.com/display/KD/%5BWS%5D+Send+Request)**.  
    ![](../../images/katalon-studio/docs/using_web_service_in_test_case/image2017-2-14 11_16_9.png)  
...
4.  The output of **[Send Request](https://docs.katalon.com/display/KD/%5BWS%5D+Send+Request)** keyword could be validated if needed using different **[Verify...](https://docs.katalon.com/display/KD/Web+Service)** keywords depending on your situation.  
    ![](../../images/katalon-studio/docs/using_web_service_in_test_case/image2017-6-30 20_50_56.png)
...
![](../../images/katalon-studio/docs/using_web_service_in_test_case/image2017-2-28 15_20_11.png)
