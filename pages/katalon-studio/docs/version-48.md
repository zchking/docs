...
<table class="wrapped confluenceTable" style="table-layout: fixed;"><thead><tr><th class="confluenceTh" style="">Keywords</th><th class="confluenceTh" style="">Description</th></tr></thead><tbody style=""><tr style=""><td class="confluenceTd" style=""><p style=""><a href="https://docs.katalon.com/display/KD/%5BWebUI%5D+Get+All+Links+On+Current+Page" rel="nofollow" style="">Get All Links On Current Page</a></p></td><td class="confluenceTd" style=""><p style="">Get all links on current page</p></td></tr><tr style=""><td class="confluenceTd" style=""><a href="https://docs.katalon.com/display/KD/%5BWS%5D+Verify+Response+Status+Code" rel="nofollow" style="">Verify Response Status Code</a></td><td class="confluenceTd" style=""><p style="">Verify status code in the returned data from a web service call</p></td></tr><tr style=""><td class="confluenceTd" style=""><a href="https://docs.katalon.com/display/KD/%5BWS%5D+Verify+Response+Status+Code+In+Range" rel="nofollow" style="">Verify Response Status Code In Range</a></td><td class="confluenceTd" style=""><p style="">Verify status code valid in a range of status codes in the returned data from a web service call</p></td></tr><tr style=""><td class="confluenceTd" style=""><a href="https://docs.katalon.com/display/KD/%5BWebUI%5D+Verify+Links+Accessible" rel="nofollow" style="">Verify Links Accessible</a></td><td class="confluenceTd" style="">Verify a list of links (URLs) are accessible</td></tr><tr style=""><td class="confluenceTd" style=""><a href="https://docs.katalon.com/display/KD/%5BWebUI%5D+Verify+All+Links+On+Current+Page+Accessible" rel="nofollow" style="">Verify All Links On Current Page Accessible</a></td><td class="confluenceTd" style="">Verify all links (URLs) on the current page are accessible</td></tr></tbody></table>