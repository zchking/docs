...
permalink: katalon-studio/docs/webui_get_viewport_top_position.html 
description: 
---
Description  
-------------
...
<table class="relative-table wrapped confluenceTable" style="width: 31.2057%;"><colgroup><col style="width: 26.0759%;"><col style="width: 73.9241%;"></colgroup><tbody><tr class="xtr-0"><th class="xtd-0-0 confluenceTh">Param Type</th><th class="xtd-0-1 confluenceTh">Description</th></tr><tr class="xtr-1"><td class="xtd-1-0 confluenceTd"><span style="color: rgb(0,0,0);">int</span></td><td class="xtd-1-1 confluenceTd"><p><span style="color: rgb(0,0,0);">Current view port top (y) position.</span></p></td></tr></tbody></table>
