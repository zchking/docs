...
permalink: katalon-studio/docs/mobile_get_device_os.html 
description: 
---
Description  
-------------
...
*   Manual view    
    ![](../../images/katalon-studio/docs/mobile_get_device_os/image2017-3-3 13_50_20.png)
*   Script view 
