...
redirect_from: "/display/KD/%5BWebUI%5D+Wait+For+Element+Visible" 
description: 
---
Description
===========
...
<table><thead><tr><th>Param Type</th><th>Description</th></tr></thead><tbody><tr><td><span>Boolean</span></td><td><ul><li><strong>true: </strong>the element is present and visible within&nbsp;the timeout.</li><li><strong>false:</strong> the element is NOT present and visible within&nbsp;the timeout.</li></ul></td></tr></tbody></table>
