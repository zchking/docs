...
*   The current Global Variables list now become the **Default Profile**. There will be **NO** 'Global Variables' interface anymore and you will need to create Global Variables in the profile you want.
...
*   There are many ways to use your profile:
    ...
    *   **For Console Mode execution**: Select your desired profile on Profile field.  
