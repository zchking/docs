...
permalink: katalon-studio/docs/webui_get_page_height.html 
description: 
---
Description  
-------------
...
<table class="wrapped confluenceTable"><colgroup><col><col></colgroup><tbody><tr class="xtr-0"><th class="xtd-0-0 confluenceTh">Param Type</th><th class="xtd-0-1 confluenceTh"><span>Description</span></th></tr><tr class="xtr-1"><td class="xtd-1-0 confluenceTd">int</td><td class="xtd-1-1 confluenceTd"><span style="color: rgb(0,0,0);">Current web page's height.</span></td></tr></tbody></table>
