...
permalink: katalon-studio/docs/webui_verify_element_clickable.html 
description: 
---
Description
-----------
...
<table class="relative-table wrapped confluenceTable" style="width: 53.3736%;"><colgroup><col style="width: 20.5761%;"><col style="width: 79.4239%;"></colgroup><tbody><tr class="xtr-0"><th class="xtd-0-0 confluenceTh" colspan="1">Param Type</th><th class="xtd-0-1 confluenceTh">Description</th></tr><tr class="xtr-1"><td class="xtd-1-0 confluenceTd" colspan="1">boolean</td><td class="xtd-1-1 confluenceTd"><ul><li><p><strong>true: </strong>the element is present and clickable.</p></li><li><strong>false: </strong>the element neither present or clickable.</li></ul></td></tr></tbody></table>
