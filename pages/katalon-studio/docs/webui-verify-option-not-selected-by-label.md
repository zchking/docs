...
Displayed texts of the options to be verified if not selected.
...
*   **true:** if all options with given displayed texts are NOT selected.
*   **false: **if all options with given displayed texts are selected
