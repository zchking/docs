...
permalink: katalon-studio/docs/webui_verify_element_not_clickable.html 
description: 
---
This keyword only works with Element has **tag** _<input>_ with attribute **disable.**

_![](../../images/katalon-studio/docs/webui_verify_element_not_clickable/uua9rf0a0ve6.png)_
