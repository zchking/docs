...
permalink: katalon-studio/docs/desired_capabilities_for_firefox_firefox_(headless).html 
description: 
---
...
![](../../images/katalon-studio/docs/desired_capabilities_for_firefox_firefox_(headless)/Untitled.png)
...
1.  Start Firefox at default page: browser.startup.homepage
    ...
    ![](../../images/katalon-studio/docs/desired_capabilities_for_firefox_firefox_(headless)/Untitled2.png)
