...
permalink: katalon-studio/docs/webui_get_window_index.html 
description: 
---
Description  
-------------
...
<table class="relative-table wrapped confluenceTable" style="width: 30.0055%;"><colgroup><col style="width: 26.1905%;"><col style="width: 73.8095%;"></colgroup><tbody><tr class="xtr-0"><th class="xtd-0-0 confluenceTh">Param Type</th><th class="xtd-0-1 confluenceTh">Description</th></tr><tr class="xtr-1"><td class="xtd-1-0 confluenceTd"><span style="color: rgb(0,0,0);">int</span></td><td class="xtd-1-1 confluenceTd"><p><span style="color: rgb(0,0,0);">Index of the current window.</span></p></td></tr></tbody></table>
