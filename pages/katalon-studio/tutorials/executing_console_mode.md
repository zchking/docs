...
<table><tbody><tr><td><b>Item</b></td><td><b>Description</b></td></tr><tr><td><span>katalon</span></td><td><span>The command of Katalon Studio to execute automation test.</span></td></tr><tr><td><span>{option(s)}</span></td><td><span>The additional </span><a><span>options</span></a><span> for the execution (see the description below for details).</span></td></tr></tbody></table>
